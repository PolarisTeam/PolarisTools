...
def readCharInfoPacket(packet):
	...
	print('Player Header: ' + repr(reader.readPlayerHeader()))
...
def readSetAreaPacket(packet):
    ...
    print('Packet Header: ' + repr(reader.readHeader()))
    print('SomePacketThing' + hexStr(reader.read(12)))
    print('SomePacketThing' + hexStr(reader.read(12)))
    # 12 DWORDs
    print('????          :' + repr(reader.readU32()))
    print('????          :' + repr(reader.readU32()))
    ...
    print('SomePacketThing' + hexStr(reader.read(12)))
    # Area name
    print('AreaName      :' + repr(reader.readString(0x7542, 0x5E)))
    ...
    print('????Str       :' + repr(reader.readString(0x7542, 0x5E)))
    print('????Str       :' + repr(reader.readString(0x7542, 0x5E)))
